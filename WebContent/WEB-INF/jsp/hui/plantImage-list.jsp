...
<body class="pos-r">
	...
	<div style="">
		<nav class="breadcrumb">
			...
			花草管理 <span class="c-gray en">&gt;</span> 花草图片 <a
		...
		<div class="page-container">
			<div class="text-c">
				<form id="searchform" method="POST" action="searchPlantImage.form">
				...
				<table
					...
					<thead>
						<tr class="text-c">
							...
							<th width="40">序号</th>
							<th width="100">花草名称</th>
							<th width="150">花草图片</th>
							<th width="250">图片描述</th>
							<th width="100">图片风格</th>
							<th width="100">图片空间</th>
							<th width="100" style="display: none"></th>
							<th width="100">图片主题</th>
							<th width="100">图片百科</th>
							<th width="100">图片季节</th>
						</tr>
					</thead>
					<tbody>
						<c:forEach items="${plantLists}" var="plantList"
							...
							<tr class="text-c va-m">
								...
								<td class="td-manage">
								<c:if test="${plantList.plantImage.plantImagePath!='' and  plantList.plantImage.plantImagePath!='plantResource/'}">
								<img width="100" height="50" class="picture-thumb" src="${plantList.plantImage.plantImagePath}">
								</c:if>
								</td>
								<td class="td-manage">${plantList.plantImage.plantImageDescribe}</td>
								<td class="td-manage">${plantList.plantImage.imageStyle}</td>
								<td class="td-manage">${plantList.plantImage.imageSpace}</td>
								<td class="td-manage" style="display:none"></td>
								<td class="td-manage">${plantList.plantImage.imageTheme}</td>
								<td class="td-manage">${plantList.plantImage.imageEncyclopedia}</td>
								<td class="td-manage">${plantList.plantImage.imageSeason}</td>
							</tr>
						</c:forEach>
					</tbody>
				</table>
